...
**Ответ:** Корневыми портами являются порты имеющие наименьшую стоимость пути до корневого коммутатора.
...
**Ответ:** Потому что изменилась стоимость пути (стоимость линков) к корневому коммутатору.
...
**Ответ:** Эти порты выбраны потому что их приоритет выше. При равных значения стоимости маршрута коорневым выбирается порт (интерфейс) с большим приоритетом.
Наивысший приоритет имеет интерфейс с меньшим числом Prio.Nbr
